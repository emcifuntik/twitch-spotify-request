...
type Streamer struct {
	...
	TwitchToken     string        `gorm:"column:streamer_twitch_token;type:longtext"`
	TwitchRefresh   string        `gorm:"column:streamer_twitch_refresh;type:longtext"`
	SpotifyToken    string        `gorm:"column:streamer_spotify_token;type:longtext"`
	SpotifyRefresh  string        `gorm:"column:streamer_spotify_refresh;type:longtext"`
